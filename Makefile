...
all: $(BIN_DIR)$(TARGET).exe $(ASSETS_DIR)PBS/PBS/pokemon.txt $(ASSETS_DIR)PBS/PBS/moves.txt
	$(BIN_DIR)$(TARGET).exe -p $(ASSETS_DIR)PBS/PBS/pokemon.txt -m $(ASSETS_DIR)PBS/PBS/moves.txt > pokemon.json
